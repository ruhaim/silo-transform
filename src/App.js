    ...
    productDetails: [
      {
        ...
        f_2134: parseInt(QuotaDetail[6].target),
        bm_1834: parseInt(QuotaDetail[7].target),
        bm_35: parseInt(QuotaDetail[8].target),
        bf_1834: parseInt(QuotaDetail[9].target),
        bf_35: parseInt(QuotaDetail[10].target),
...
export default function App() {
  ...
  return (
    <div className="App">
      ...
      >
        <label>Refid</label>
        <textarea name="referenceId" />
        <br />
        eg:1e2aa331-702e-48e0-9134-7163f0cf2faf
        <br />
        <label>in JSON</label>
        <textarea name="oldJSON" />
